...
const csv = fs.readFileSync("csv/life.csv");
...
const Lifecrawler = async () => {
    try {
        ...
        for (const [i, r] of records.entries()) {
            ...
            await page.click('#footer > div.ft_sitemap > ul > li:nth-child(13) > a');
        ...
        fs.writeFileSync('csv/liferesult.csv', str);  // Fix the typo here
    } catch (err) {
        console.error(err);
    }
}
