...
const Techcrawler = async () => {
    try {
        ...
        for (const [i, r] of records.entries()) {
            ...
            await page.click('#footer > div.ft_sitemap > ul > li:nth-child(7) > a');
        ...
        fs.writeFileSync('csv/techresult.csv', str);  // Fix the typo here
    } catch (err) {
        console.error(err);
    }
}
