...
const csv = fs.readFileSync("csv/social.csv");
...
const Socialcrawler = async () => {
    try {
        ...
        for (const [i, r] of records.entries()) {
            ...
            await page.click('#footer > div.ft_sitemap > ul > li:nth-child(10) > a');
        ...
        fs.writeFileSync('csv/socialresult.csv', str);  // Fix the typo here
    } catch (err) {
        console.error(err);
    }
}
