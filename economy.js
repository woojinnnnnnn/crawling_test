...
const csv = fs.readFileSync("csv/economy.csv");
...
const Economycrawler = async () => {
    try {
        ...
        fs.writeFileSync('csv/economyresult.csv', str);  // Fix the typo here
    } catch (err) {
        console.error(err);
    }
}
