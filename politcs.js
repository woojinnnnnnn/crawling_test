...
const csv = fs.readFileSync("csv/politics.csv");
...
const Politicscrawler = async () => {
    try {
        ...
        for (const [i, r] of records.entries()) {
            ...
            await page.click('#footer > div.ft_sitemap > ul > li:nth-child(8) > a');
        ...
        fs.writeFileSync('csv/politicsresult.csv', str);  // Fix the typo here
    } catch (err) {
        console.error(err);
    }
}
